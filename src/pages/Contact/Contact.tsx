          ...
          <div className="row">
            <div className="col-sm-6 col-md-6">
              <div className="contact-instructions">
                ...
                <p>
                  Don&apos;t be afraid to contact me! I&apos;m happy to answer
                  any questions, provide more information, or just have a nice
                  ...
                  <div className="row">
                    <div className="col-sm-4 col-md-4 col-sm-offset-4 col-md-offset-4">
                      <div className="submit-contact">
                        <Link className="btn btn-default btn-border" to="#">
                          Submit
                        </Link>
                      </div>
                    </div>
